...
our prototype and compares the results with other vulnerability 
...
the unique path discovery performance of whole prototype and 
...
two benchmarks, and discuss the testing results of our prototype
...
different vulnerability discovery tools as well as our prototype 
...
many states, like \texttt{strcpy}, \texttt{strcat}, \texttt{crc16},
 and \texttt{crc32}. Based on these models, S2E and our prototype 
...
With the help of our seed selection method, our prototype selected 
...
our prototype successfully triggered the bug after covering all 
...
Our prototype discovered 62 bugs which was much more than the FUZZER and the 
...
of VUzzer and our prototype in this table. 
\begin{table}[!b]
...
more of any input, whereas our prototype successfully triggered 29 bugs in 
\texttt{md5sum}.
...
From the table we can see that during 24 hours, our prototype triggered 403 
...
overall viewpoint, our prototype can discover 43.49\% more unique paths 
