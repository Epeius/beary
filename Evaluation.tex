The evaluation of our prototype consists of two parts: \textbf{\emph{path discovery}} and \textbf{\emph{bug finding}}. 
 Path discovery is devised to evaluate our distance based seed selection on several real-world binary programs, and \textit{SPF} component is disabled to illustrate more clearly. 
